...
function BaseApp() {
    ...
    this.objectList = [];
    this.root = null;
    this.mouse = { startX:0, startY:0, endX:0, endY:0 };
    this.pickedObjects = [];
...
BaseApp.prototype.createRenderer = function() {
    ...
    this.renderer.setSize(width, (width*2)/3);
...
BaseApp.prototype.windowResize = function(event) {
    ...
    this.renderer.setSize( this.container.clientWidth, (this.container.clientWidth*2)/3);
    //console.log('Size =', )
};
